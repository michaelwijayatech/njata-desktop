            ...
            if(responseJson.status.toString() === global_var.STATUS_SUCCESS.toString()){
                for(var i=0; i<responseJson.message.length; i++){
                    $("#table-body").append(
                        ...
                        "<td id='"+responseJson.message[i].id+"@!#"+responseJson.message[i].name+"' onclick=\"_setChoose(this)\" class=\"text-center width width-80 color-green1 cursor-pointer\">Choose</td>" +
                        "</tr>"
                    )
                }
            }
            ...
            if(responseJson.status.toString() === global_var.STATUS_SUCCESS.toString()){
                ...
                for(var i=0; i<responseJson.message.length; i++){
                    $("#custom-table").append(
                        ...
                        "<tr> <th colspan=\"5\">"+responseJson.message[i].group_name+"</th> <th colspan=\"1\" contenteditable='true' class='groups-cartons text-center' data-id1='"+responseJson.message[i].carton_id+"'>"+responseJson.message[i].carton+"</th> </tr>"+
                        "</thead>"+
